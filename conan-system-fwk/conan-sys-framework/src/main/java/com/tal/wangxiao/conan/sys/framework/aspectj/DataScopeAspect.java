package com.tal.wangxiao.conan.sys.framework.aspectj;
...
import com.tal.wangxiao.conan.sys.common.core.domain.BaseEntity;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.tal.wangxiao.conan.sys.common.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias) {
        ...
        if (StringUtils.isNotBlank(sqlString.toString())) {
            ...
            } else if (StringUtils.isNotNull(params) && params instanceof ConanBaseEntity) {
                ConanBaseEntity baseEntity = (ConanBaseEntity) params;
                baseEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
            }
        }
    }
