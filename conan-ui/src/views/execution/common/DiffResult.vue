<template>
  <div>
    <!-- 单条比对 -->
    <div >
      <div class="box-card felxCard" style="background: #fff; height: 100%; padding: 0 5px 5px 5px">
...
export default {
  ...
  created() {
    this.successRate = this.$route.query.successRate?this.$route.query.successRate:0;
...
.mergely-conan { margin:10px auto; width: 100%; min-height: 680px; max-height: 680px }
...
.mergely.a.rhs { background-color: #ddeeff; color: blue!important; }
...
.mergely.ch.d.lhs { background-color: pink; text-decoration: line-through; color: red !important; }
