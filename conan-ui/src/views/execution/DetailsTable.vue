    ...
    >
      ...
      <el-table-column align="center" label="回放成功率" prop="success_rate">
        <template slot-scope="scope">
          <el-progress
            :text-inside="true"
            :stroke-width="20"
            :percentage="Number(scope.row.success_rate)"
          ></el-progress>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          ...
          >
            <el-button
              @click="setAsBaseLine(scope.row.id)"
              v-if="scope.row.is_baseline != true"
              size="mini"
              plain
              type="success"
          ...
          >
            <el-button
              v-on:click="startDiff(scope.row.id)"
              v-if="
              ...
              size="mini"
              circle
              class="icon-ziyuan1282 iconfont el-button--lvse"
            ></el-button>
          </el-tooltip>
          <el-tooltip
            class="item"
          ...
          >
            <el-button
              @click="getDiffList(scope.row)"
              v-if="scope.row.success_rate != '0'"
              type="primary"
              circle
              size="mini"
              class="iconfont icon-jiaochabidui"
            ></el-button>
          </el-tooltip>
          <el-tooltip
            class="item"
          ...
          >
            <el-button
              @click="getReplayDetail(scope.$index, scope.row)"
              size="mini"
              circle
              type="warning"
...
<script>
import { setBaseLineByTaskExecutionID, getToDiff } from "@/api/execution/printDiffLog.js";
