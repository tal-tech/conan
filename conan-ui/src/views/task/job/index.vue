        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="任务分组" prop="jobGroup">
              <el-select v-model="form.jobGroup" placeholder="请选择" disabled>
                <el-option
                  v-for="dict in jobGroupOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="24">
            <el-form-item prop="invokeTarget">
              <span slot="label"> 任务ID </span>
                <el-input placeholder="任务ID" v-model="form.invokeTarget" auto-complete="off" >
...
export default {
  ...
  methods: {
    ...
    findTaskId(){
     ...
     // 添加add
    addRow(row){
      this.form.invokeTarget=row.taskId;
    ...
    handleUpdate(row) {
      ...
      getJob(jobId).then((response) => {
        this.form = response.data;
        this.form.invokeTarget= this.form.invokeTarget.split('(')[1].split(',')[0];
        this.form.type= '0';
        this.open = true;
        this.title = "修改任务";
      });
    ...
    submitForm: function () {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.type=='1') {
            this.form.invokeTarget=`taskPipelineService.asyncTaskRecordPipeline(${this.form.invokeTarget},0,"online")`;
          }else{
            this.form.invokeTarget=`taskPipelineService.asyncTaskReplayPipeline(${this.form.invokeTarget},0,"online")`;
          }
